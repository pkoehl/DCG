...
c===================================================================================
c
c	kmnsdrv.f		Version 1 5/22/2017		Patrice Koehl
c									Jiahui Guan
c
c	This is the driver routine for kmns; it is called from the
c	C++ code for DCG
c
c===================================================================================
c===================================================================================
c
	subroutine kmnsdrv(N, Ncoord, Data, Ncluster, Centers, WorkD,
     1				WorkI, iter, score)
c
c===================================================================================
c===================================================================================
...
c		Ncoord:				number of coordinates per data point
c		Data:				data matrix (size N*Ncoord)
c		Ncluster:			number of clusters to be found
c		Centers:			current cluster centers (size Ncluster*Ncoord)
c		WorkD:				work array (doubles)
c		WorkI:				work array (integers)
c		iter:				number of iterations for kmns
c	Output:
c		WorkI(1:N)			Cluster assignment for each point
c		score:				quality of the clustering (sum of the
c						variances of the clusters)
c===================================================================================
c===================================================================================
c
	integer	i,ierr
	integer	N,Ncoord,Ncluster,iter
	integer	k_ic1,k_ic2,k_nc,k_ncp,k_itran,k_ilive
	integer	k_d,k_an1,k_an2,k_wss
c
	integer	WorkI(*)
c
	real*8	score
	real*8	Data(*),Centers(*),WorkD(*)
c
	k_ic1 = 1
	k_ic2 = k_ic1 + N
	k_nc  = k_ic2 + N
	k_ncp = k_nc + Ncluster
	k_itran = k_ncp + Ncluster
	k_ilive = k_itran + Ncluster
c
	k_wss = 1
	k_d   = k_wss + Ncluster
	k_an1 = k_d + N
	k_an2 = k_an1 + Ncluster
c
	call kmns(Data, N, Ncoord, Centers, Ncluster, WorkI(k_ic1),
     1		WorkI(k_ic2),WorkI(k_nc),WorkD(k_an1),WorkD(k_an2),
     2		WorkI(k_ncp),WorkD(k_d),WorkI(k_itran),WorkI(k_ilive),
     3		iter,WorkD(k_wss),ierr)
c
	score = 0.d0
	do 100 i = 1,Ncluster
		score = score + WorkD(i)
...
c===================================================================================
c
c b/text-analysis/trunk/Clustering/misc/kmns.f
...
C Declaration re-ordering to satisfy "f77 -ansi",  M.Maechler
C 2001/04/12
C
